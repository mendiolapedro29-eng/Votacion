  ...
  const preguntasFrecuentes = [
    {
      ...
      respuesta: "Sí: El sistema de votación en línea está diseñado con múltiples capas de seguridad para proteger la integridad y confidencialidad de su voto."
    },
    {
      pregunta: "¿Cómo sabré si estoy registrado para el Voto Digital? Y ¿Cuándo?",
      respuesta: "Podrás verificar tu registro en el padrón electoral digital a través de la plataforma oficial del JNE. La verificación estará disponible 30 días antes de las elecciones."
    },
    {
      pregunta: "¿Luego de registrado podré cambiar de modalidad de votación?",
      respuesta: "No, una vez que te registras para el voto digital, esta modalidad será la única disponible para ti en estas elecciones. No podrás cambiar a voto presencial."
    },
    {
      pregunta: "¿Al elegir esta modalidad, también podré votar de forma presencial?",
      respuesta: "No, el voto digital y el voto presencial son modalidades excluyentes. Si optas por el voto digital, no podrás votar de forma presencial en la misma elección."
    },
    {
      pregunta: "¿Cómo es el proceso de votación?",
      respuesta: "El proceso consta de 6 pasos: acceso al sistema con tu DNI, verificación de datos, selección de opciones, revisión del voto, envío y registro, y recepción del comprobante digital."
    },
    {
        ...
        <div className="max-w-5xl mx-auto">
          ...
          >
            {preguntasFrecuentes.map((faq, index) => (
              <div
                key={index}
                className="bg-[#F8FAFC] border border-gray-200 rounded-xl overflow-hidden"
              >
                <button
